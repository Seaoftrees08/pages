...
export default function SideSettings(props: {toggleAllowDuplicates: ()=>void, allowDuplicates: boolean}) {

    const {toggleAllowDuplicates, allowDuplicates} = props;

    return (
        <div className="p-8 min-w-1/4 w-1/3 h-screen bg-gray-800 text-slate-200">
